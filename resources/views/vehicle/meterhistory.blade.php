                                        ...
                                        <div class="tab-pane fade show active" id="home" role="tabpanel"
                                            ...
                                            <div class="wg-box" id="vehicle-table">
                                                <div class="filter-container">
                                                    ...
                                                    <div class="dropdown">
                                                        <button class="dropbtn">Meter Date▼</button>
                                                    ...
                                                    <div class="dropdown">
                                                        <button class="dropbtn">Meter Type ▼</button>
                                                        <div class="dropdown-content">
                                                            <form class="form-search">
                                                                <div class="custom-search-container">
                                                                    <input type="text" placeholder="Search text"
                                                    ...
                                                    <div class="dropdown">
                                                        <button class="dropbtn">Void Status ▼</button>
                                                        <div class="dropdown-content">
                                                            <form class="form-search">
                                                                <div class="custom-search-container">
                                                                    <input type="text" placeholder="Search text"
                                                ...
                                                <div class="wg-table table-product-list">
                                                    <ul class="table-title">
                                                        ...
                                                        <li class="body-title">Meter Value</li>
                                                        <li class="body-title">Meter Type</li>
                                                        <li class="body-title">

                                                            Void
                                                        </li>
                                                        <li class="body-title">Source</li>


                                                        <li class="body-title">Void Status</li>
