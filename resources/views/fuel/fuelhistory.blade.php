                                        ...
                                        <div class="tab-pane fade show active" id="home" role="tabpanel"
                                            ...
                                            <div class="wg-box" id="vehicle-table">
                                                <div class="fuel-stats-container">
                                                    ...
                                                    <div class="stat-box">
                                                        ...
                                                        <div class="stat-value">247.17 <span
                                                                class="stat-unit">gallons</span></div>
                                                    </div>

                                                    <div class="stat-box">
                                                        <div class="stat-title">Avg. Fuel Economy (Distance)</div>
                                                        <div class="stat-value">25.78 <span class="stat-unit">mpg
                                                                (US)</span></div>
                                                    </div>

                                                    <div class="stat-box">
                                                        <div class="stat-title">Avg. Fuel Economy (Hours)</div>
                                                ...
                                                <div class="filter-container">
                                                    ...
                                                    <div class="dropdown">
                                                        <button class="dropbtn">Vehicle Group ▼</button>
                                                        <div class="dropdown-content">
                                                            <form class="form-search">
                                                                <div class="custom-search-container">
                                                                    <input type="text" placeholder="Search text"
                                                ...
                                                <div class="wg-table table-product-list">
                                                    <ul class="table-title">
                                                        ...
                                                        <li class="body-title"
                                                            ...
                                                            <span class="tooltip-icon">Volume</span>
                                                            <div class="tooltip">Measurement unit per vehicle
                                                                settings
                                                            </div>
                                                        </li>
                                                        <li class="body-title"
                                                            ...
                                                            <span class="tooltip-icon">Total</span>
                                                            <div class="tooltip">Volume measurement unit per vehicle
                                                                settings</div>
                                                        </li>
                                                        <li class="body-title"
                                                            style="position: relative; display: inline-block;">

                                                            <span class="tooltip-icon">Fuel Economy</span>
                                                            <div class="tooltip">Measurement unit per user settings
                                                            </div>
                                                        </li>
                                                        <li class="body-title"
                                                            style="position: relative; display: inline-block;">

                                                            <span class="tooltip-icon">Cost Per Meter</span>
                                                            <div class="tooltip">Primary meter units per vehicle
                                                                settings</div>
                                                        </li>
