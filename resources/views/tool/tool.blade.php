                            ...
                            <div class="main-content-wrap">
                                <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                                    ...
                                    <ul class="breadcrumbs flex items-center flex-wrap gap10">
                                        ...
                                        <a class="tf-button style-1 w208" href="{{url('/AddTool')}}">
                                            <i class="icon-plus"></i>
                                            Add
                                            Tool
                                        </a>
                                ...
                                <div class="container mt-4">
                                    ...
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="charging-tab" data-bs-toggle="tab"
                                                data-bs-target="#charging" type="button" role="tab"
                                                aria-controls="charging" aria-selected="false">Assigned</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="fuel-tab" data-bs-toggle="tab"
                                                data-bs-target="#fuel" type="button" role="tab" aria-controls="fuel"
                                        ...
                                        <div class="tab-pane fade show active" id="home" role="tabpanel"
                                            ...
                                            <div class="wg-box" id="vehicle-table">
                                                <div class="filter-container">
                                                    ...
                                                    <div class="dropdown">
                                                        <button class="dropbtn">Tool Type ▼</button>
                                                    ...
                                                    <div class="dropdown">
                                                        <button class="dropbtn">Tool Group ▼</button>
                                                        <div class="dropdown-content">
                                                            <form class="form-search">
                                                                <div class="custom-search-container">
                                                ...
                                                <div class="wg-table table-product-list">
                                                    <ul class="table-title">
                                                        ...
                                                        <li class="body-title">Current Assignee</li>
                                                        <li class="body-title">Labels</li>
                                                        <li class="body-title">Linked Vehicle</li>

                                                        <li class="body-title">Vehicle Operator</li>

                                                        <li class="body-title">Open Issues</li>
                                                    ...
                                                    <ul>
                                                        <li class="product-item">
                                                            ...
                                                            <div class="body-text">Linked Vehicle 1</div>

                                                            <div class="body-text">Vehicle Operator 1</div>

                                                            <div class="body-text">Open Issues 1</div>
